...
import { CategoryExperienceGrid } from "@/app/explore/region/[slug]/CategoryExperienceGrid";
...
import { resolveLocalizedText } from "@/lib/seo/page-metadata";
...
export default async function ExploreCategoryPage({
  ...
  const rawTitle = category
    ? resolveLocalizedTitle(category.title, locale)
    : null;
  const categoryTitle = rawTitle ? rawTitle.trim() : null;
  const categoryDescription = category
    ? resolveLocalizedText(category.description, locale)
    : null;
