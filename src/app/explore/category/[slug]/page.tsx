...
export default async function ExploreCategoryPage({
  ...
  let category: { id: string; title: { fr: string; en: string; ar: string }; description: string | null } | null = null;
  ...
  try {
    ...
    category = ((allCategories as typeof category[] | null) ?? []).find(
      (c) => c && categoryMatchesSlug(c, routeSlug),
    ) ?? null;
    ...
    if (category) {
      ...
      experiences = (rows ?? []).map((r: any) => transformExperience(r.experience));
    }
  } catch {
