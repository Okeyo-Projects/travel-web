...
export function GuideItemCard({ item, onOpenImageViewer }: GuideItemCardProps) {
  ...
  const kindLabels: Record<GuideItemKind, string> = {
    ...
    coffee: t("chat.guideItemCard.kind.coffee"),
    bakery: t("chat.guideItemCard.kind.bakery"),
    nightlife: t("chat.guideItemCard.kind.nightlife"),
    beach: t("chat.guideItemCard.kind.beach"),
    nature: t("chat.guideItemCard.kind.nature"),
    viewpoint: t("chat.guideItemCard.kind.viewpoint"),
    market: t("chat.guideItemCard.kind.market"),
    family: t("chat.guideItemCard.kind.family"),
    religious: t("chat.guideItemCard.kind.religious"),
    coworking: t("chat.guideItemCard.kind.coworking"),
    parking: t("chat.guideItemCard.kind.parking"),
    pharmacy: t("chat.guideItemCard.kind.pharmacy"),
    money_exchange: t("chat.guideItemCard.kind.money_exchange"),
    tourist_info: t("chat.guideItemCard.kind.tourist_info"),
    rooftop: t("chat.guideItemCard.kind.rooftop"),
    pub: t("chat.guideItemCard.kind.pub"),
