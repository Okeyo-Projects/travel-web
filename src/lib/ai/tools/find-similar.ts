...
const findSimilarSchema = z.object({
  ...
  same_region: z
    .boolean()
    .optional()
    .describe("Only find experiences in the same region"),
  same_type: z
    .boolean()
    .optional()
    .describe("Only find experiences of the same type"),
  limit: z
    .number()
    .optional()
    .default(5)
    .describe("Maximum number of similar experiences to return"),
});
