export const ANALYTICS_EVENT = {
  ...
  CHAT_LEAD_CAPTURE_OPENED: "chat_lead_capture_opened",
  CHAT_LEAD_CAPTURE_SUBMITTED: "chat_lead_capture_submitted",
  CHAT_LEAD_CAPTURE_LATER_CLICKED: "chat_lead_capture_later_clicked",
