...
export const EXPERIENCES: ExperienceListItem[] = [
  {
    ...
    short_description:
      "Glide from the Skytree observatory into hidden izakayas with a local food curator.",
    city: "Tokyo",
    region: "Kanto",
    type: "activity",
    thumbnail_url:
  ...
  },
  {
    ...
    short_description:
      "Sail around the caldera with a private chef on board, ending with a bioluminescent swim.",
    city: "Santorini",
    region: "South Aegean",
    type: "trip",
    thumbnail_url:
  ...
  },
  {
    ...
    short_description:
      "Land on remote blue ice and trek with glacier guides, including drone footage package.",
    city: "El Chaltén",
    region: "Santa Cruz",
    type: "activity",
    thumbnail_url:
      "https://images.unsplash.com/photo-1526481280695-3c469c011b4d?auto=format&fit=crop&w=1200&q=80",
    avg_rating: 4.97,
    reviews_count: 87,
    host: {
      id: "h3",
  ...
  },
  {
    ...
    short_description:
      "Immerse yourself in nature in this sustainable bamboo villa overlooking a private waterfall.",
    city: "Ubud",
    region: "Bali",
    type: "lodging",
    thumbnail_url:
      "https://images.unsplash.com/photo-1572097662444-658d35d978a3?auto=format&fit=crop&w=1200&q=80",
    avg_rating: 4.95,
    reviews_count: 412,
    host: {
      id: "h4",
  ...
  },
  {
    ...
    short_description:
      "Private tea ceremony with a 15th-generation tea master in a temple not open to the public.",
    city: "Kyoto",
    region: "Kansai",
    type: "activity",
    thumbnail_url:
