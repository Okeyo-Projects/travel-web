...
const TRANSLATIONS = {
  en: {
    titles: {
      ...
      booking_request: 'Booking Request Sent',
    ...
    bodies: {
      ...
      booking_request: 'Your booking request for {{experience}} has been sent to the host.',
      ...
      booking_approved:
        'Your booking for {{experience}} has been approved! Please complete payment.',
      ...
      experience_drafted:
        'Your experience "{{experience}}" has been set to draft as all dates are in the past. Please add new dates to publish again.',
    },
  },
  fr: {
    titles: {
      ...
      booking_request: 'Demande de réservation envoyée',
    ...
    bodies: {
      ...
      booking_request: "Votre demande de réservation pour {{experience}} a été envoyée à l'hôte.",
      ...
      booking_approved:
        'Votre réservation pour {{experience}} a été approuvée ! Veuillez compléter le paiement.',
      ...
      experience_drafted:
        'Votre expérience "{{experience}}" a été passée en brouillon car toutes les dates sont dans le passé. Veuillez ajouter de nouvelles dates pour republier.',
    },
  },
  ar: {
    titles: {
      ...
      booking_request: 'تم إرسال طلب الحجز',
    ...
    bodies: {
      ...
      booking_request: 'تم إرسال طلب الحجز لـ {{experience}} إلى المضيف.',
      ...
      experience_drafted:
        'تم تحويل تجربتك "{{experience}}" إلى مسودة لأن جميع التواريخ في الماضي. يرجى إضافة تواريخ جديدة للنشر مرة أخرى.',
    },
  },
};
...
serve(async (req) => {
  try {
    ...
    let entityId = null;
    const actionUrl =
      typeof data?.action_url === 'string' && data.action_url.length > 0 ? data.action_url : null;
    ...
    if (!serviceAccount.project_id || !serviceAccount.client_email || !serviceAccount.private_key) {
      ...
      return new Response(
        JSON.stringify({ error: 'Incomplete Firebase service account configuration' }),
        {
          status: 500,
          headers: { 'Content-Type': 'application/json' },
        },
