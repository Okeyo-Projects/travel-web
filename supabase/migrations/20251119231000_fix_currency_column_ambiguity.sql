-- =====================================================
-- FIX: Resolve currency column ambiguity
-- =====================================================
-- This migration fixes the "column reference 'currency' is ambiguous" error
...
COMMENT ON FUNCTION get_booking_quote(UUID, DATE, DATE, INT, INT, INT, TEXT, UUID, TEXT, UUID) IS
  'Calculate booking quote with automatic promotion application. Accepts p_rooms as TEXT (JSON string from client). All column references are qualified with table aliases to avoid ambiguity.';
