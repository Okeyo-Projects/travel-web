-- =====================================================
-- Fix Experience Comments Count
-- =====================================================
-- This migration ensures comments_count is properly tracked
-- for experiences and reels, counting all comments including replies
-- =====================================================

-- =====================================================
-- Add comments_count to experiences if it doesn't exist
-- =====================================================
...
DROP TRIGGER IF EXISTS trg_update_experience_comments_count ON comments;
...
-- Drop existing trigger if it exists
DROP TRIGGER IF EXISTS trg_update_reel_comments_count ON comments;
...
-- =====================================================
-- Initialize/Recalculate existing counts
-- =====================================================
-- Recalculate comments_count for all existing experiences
-- This ensures counts are accurate even if triggers weren't working before
-- =====================================================
...
-- Recalculate comments_count for all existing reels
UPDATE reels r
SET comments_count = (
  SELECT COUNT(*)
  FROM comments c
...
COMMENT ON FUNCTION update_experience_comments_count IS
  'Automatically updates comments_count on experiences when comments are added/deleted (counts all comments including replies)';

COMMENT ON FUNCTION update_reel_comments_count IS
  'Automatically updates comments_count on reels when comments are added/deleted for linked experiences (counts all comments including replies)';
