-- Fix get_pending_review_requests to use correct column names for host info
-- Issue: profiles table has 'display_name' not 'name'
-- Since we need host info, we should get it from the hosts table directly
