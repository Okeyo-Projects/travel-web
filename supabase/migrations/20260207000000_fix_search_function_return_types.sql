-- =====================================================
-- FIX: search_experiences_enhanced return type mismatch
-- Column 12 (distance_km) and 13 (relevance_score) were declared
-- as REAL but computed as DOUBLE PRECISION by ST_Distance and
-- vector <=> operator. This caused error 42804.
-- =====================================================

-- Must DROP first since changing return types is not allowed with CREATE OR REPLACE
